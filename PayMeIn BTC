...
profit = []
BTC_Balance = []
p = input("Enter number of paychecks to assess: ")

for i in range(int(p)): #user enters loops per paycheck.
  original = float(input("Whats the current or original price of Bitcoin for when you plan to or have invested?: "))
  ...
  print(" ")
  profit.append(invest_profit_diff)
total1 = sum(profit) #this is the total of profit in raw form
total2 = round(total1, 2) #this is the total rounded to the 2nd decimal place
print("Your profit based off the entered paychecks is a total of $" + str(total2) )  
